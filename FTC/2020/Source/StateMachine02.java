...
@Autonomous(name="State Machine 02", group="zJim Test")

public class StateMachine02 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        StopWatch waitOneSecond = new StopWatch(1000);
        ...
        while (opModeIsActive()) {
            ...
            switch(mState)
            {
                case(STATE_RUN_FORWARD1):
                    ...
                    if(true == waitOneSecond.isExpired())
                    {
                        waitOneSecond.reset();
